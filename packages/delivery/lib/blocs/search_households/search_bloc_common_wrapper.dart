...
class SearchBlocDeliveryWrapper implements StateStreamableSource<Object?> {
  final SearchHouseholdsDeliveryBloc searchHouseholdsBloc;
  final TagSearchDeliveryBloc tagSearchBloc;
  final IndividualGlobalDeliverySearchBloc individualGlobalSearchBloc;
  final HouseHoldGlobalDeliverySearchBloc houseHoldGlobalSearchBloc;

  SearchBlocDeliveryWrapper(
