...
mixin _$SearchHouseholdsState {
  ...
  List<HouseholdMemberDeliveryWrapper> get householdMembers =>
      throw _privateConstructorUsedError;
...
abstract class $SearchHouseholdsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? searchQuery,
      String? tag,
      List<HouseholdMemberDeliveryWrapper> householdMembers,
      int totalResults});
}
    ...
    return _then(_value.copyWith(
      ...
      householdMembers: null == householdMembers
          ...
          : householdMembers // ignore: cast_nullable_to_non_nullable
              as List<HouseholdMemberDeliveryWrapper>,
...
class _$SearchHouseholdsStateImpl extends _SearchHouseholdsState {
  const _$SearchHouseholdsStateImpl(
      ...
      this.searchQuery,
      this.tag,
      final List<HouseholdMemberDeliveryWrapper> householdMembers = const [],
      this.totalResults = 0})
  ...
  @override
  final String? tag;
  final List<HouseholdMemberDeliveryWrapper> _householdMembers;
  @override
  @JsonKey()
  List<HouseholdMemberDeliveryWrapper> get householdMembers {
...
abstract class _SearchHouseholdsState extends SearchHouseholdsState {
  const factory _SearchHouseholdsState(
      ...
      final String? searchQuery,
      final String? tag,
      final List<HouseholdMemberDeliveryWrapper> householdMembers,
...
mixin _$HouseholdMemberDeliveryWrapper {
  ...
  @JsonKey(ignore: true)
  $HouseholdMemberDeliveryWrapperCopyWith<HouseholdMemberDeliveryWrapper>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $HouseholdMemberDeliveryWrapperCopyWith<$Res> {
  factory $HouseholdMemberDeliveryWrapperCopyWith(
          HouseholdMemberDeliveryWrapper value,
          $Res Function(HouseholdMemberDeliveryWrapper) then) =
      _$HouseholdMemberDeliveryWrapperCopyWithImpl<$Res,
...
/// @nodoc
class _$HouseholdMemberDeliveryWrapperCopyWithImpl<$Res,
        $Val extends HouseholdMemberDeliveryWrapper>
    implements $HouseholdMemberDeliveryWrapperCopyWith<$Res> {
  _$HouseholdMemberDeliveryWrapperCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$HouseholdMemberDeliveryWrapperImplCopyWith<$Res>
    implements $HouseholdMemberDeliveryWrapperCopyWith<$Res> {
  factory _$$HouseholdMemberDeliveryWrapperImplCopyWith(
          _$HouseholdMemberDeliveryWrapperImpl value,
          $Res Function(_$HouseholdMemberDeliveryWrapperImpl) then) =
      __$$HouseholdMemberDeliveryWrapperImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {HouseholdModel? household,
...
/// @nodoc
class __$$HouseholdMemberDeliveryWrapperImplCopyWithImpl<$Res>
    extends _$HouseholdMemberDeliveryWrapperCopyWithImpl<$Res,
        _$HouseholdMemberDeliveryWrapperImpl>
    implements _$$HouseholdMemberDeliveryWrapperImplCopyWith<$Res> {
  __$$HouseholdMemberDeliveryWrapperImplCopyWithImpl(
      _$HouseholdMemberDeliveryWrapperImpl _value,
      $Res Function(_$HouseholdMemberDeliveryWrapperImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$HouseholdMemberDeliveryWrapperImpl(
      household: freezed == household
          ? _value.household
          : household // ignore: cast_nullable_to_non_nullable
              as HouseholdModel?,
...
class _$HouseholdMemberDeliveryWrapperImpl
    implements _HouseholdMemberDeliveryWrapper {
  const _$HouseholdMemberDeliveryWrapperImpl(
      {this.household,
  ...
  @override
  String toString() {
    return 'HouseholdMemberDeliveryWrapper(household: $household, headOfHousehold: $headOfHousehold, members: $members, projectBeneficiaries: $projectBeneficiaries, distance: $distance, tasks: $tasks, sideEffects: $sideEffects, referrals: $referrals)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$HouseholdMemberDeliveryWrapperImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$HouseholdMemberDeliveryWrapperImplCopyWith<
          _$HouseholdMemberDeliveryWrapperImpl>
      get copyWith => __$$HouseholdMemberDeliveryWrapperImplCopyWithImpl<
          _$HouseholdMemberDeliveryWrapperImpl>(this, _$identity);
}

abstract class _HouseholdMemberDeliveryWrapper
    implements HouseholdMemberDeliveryWrapper {
