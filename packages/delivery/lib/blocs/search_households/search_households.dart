...
class SearchHouseholdsDeliveryBloc
  ...
  final HouseHoldGlobalDeliverySearchRepository houseHoldGlobalSearchRepository;

  SearchHouseholdsDeliveryBloc(
      ...
      required this.individualGlobalDeliverySearchRepository,
  ...
  Future<List<HouseholdMemberModel>> fetchHouseholdMembersBulk(
    ...
    return await householdMember.search(
      HouseholdMemberSearchModel(
        ...
        isHeadOfHousehold:
            RegistrationSingleton().householdType == HouseholdType.community
                ? true
                : null,
      ),
    );
...
class SearchHouseholdsState with _$SearchHouseholdsState {
  ...
  const factory SearchHouseholdsState({
    ...
    String? searchQuery,
    String? tag,
    @Default([]) List<HouseholdMemberDeliveryWrapper> householdMembers,
...
@freezed
class HouseholdMemberDeliveryWrapper with _$HouseholdMemberDeliveryWrapper {
  const factory HouseholdMemberDeliveryWrapper({
  ...
  }) = _HouseholdMemberDeliveryWrapper;
}
