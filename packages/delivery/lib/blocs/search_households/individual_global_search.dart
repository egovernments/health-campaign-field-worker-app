...
class IndividualGlobalDeliverySearchBloc extends SearchHouseholdsDeliveryBloc {
  IndividualGlobalDeliverySearchBloc(
      ...
      required super.individualGlobalDeliverySearchRepository,
  ...
  Future<void> _individualGlobalSearch(
    ...
    final containers = <HouseholdMemberDeliveryWrapper>[
    ...
    final results =
        await individualGlobalDeliverySearchRepository.individualGlobalSearch(
  ...
  _processHouseholdEntries(
      ...
      List<SideEffectModel> sideEffectsList,
      List<ReferralModel> referralsList,
      List<HouseholdMemberDeliveryWrapper> containers) async {
