...
class HouseHoldGlobalDeliverySearchBloc extends SearchHouseholdsDeliveryBloc {
  HouseHoldGlobalDeliverySearchBloc({
  ...
  Future<void> _processHouseholdEntries(
    ...
    List<SideEffectModel> sideEffectsList,
    List<ReferralModel> referralsList,
    List<HouseholdMemberDeliveryWrapper> containers,
  ) async {
