...
class StatusFilterState extends LocalizedState<StatusFilter> {
                  ...
                  child: SelectionCard<Status>(
                    ...
                    valueMapper: (value) {
                      return localizations.translate(value ==
                          ...
                          ? '${DeliverySingleton().selectedProject!.projectType}_${value.toValue().toString()}'
  ...
  getFilters() {
    ...
    finalStatues.addAll((DeliverySingleton().householdType ==
                HouseholdType.community
            ? DeliverySingleton().searchCLFFilters ?? []
