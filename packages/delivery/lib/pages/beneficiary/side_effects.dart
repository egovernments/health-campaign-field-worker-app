...
class SideEffectsPageState extends LocalizedState<SideEffectsPage> {
  ...
  void initState() {
    super.initState();
    symptomTypesOptions = (DeliverySingleton().symptomsTypes ?? [])
        .map((e) => KeyValue(e, e))
        .toList();
        ...
        builder: (context, productState) {
          return productState.maybeWhen(
            ...
            fetched: (productVariants) {
              return BlocBuilder<HouseholdOverviewDeliveryBloc,
  ...
  void submitSideEffects() async {
    final reloadState = context.read<HouseholdOverviewDeliveryBloc>();
