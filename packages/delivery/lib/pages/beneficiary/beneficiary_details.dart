...
import 'package:delivery/pages/beneficiary/widgets/past_delivery.dart';
...
@RoutePage()
class BeneficiaryDetailsDeliveryPage extends LocalizedStatefulWidget {
  const BeneficiaryDetailsDeliveryPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<BeneficiaryDetailsDeliveryPage> createState() =>
      BeneficiaryDetailsDeliveryPageState();
}

class BeneficiaryDetailsDeliveryPageState
    extends LocalizedState<BeneficiaryDetailsDeliveryPage> {
  @override
  void initState() {
    ...
    return ProductVariantBlocWrapper(
      child: BlocBuilder<HouseholdOverviewDeliveryBloc,
        ...
        builder: (context, state) {
          final householdMemberWrapper = state.householdMemberDeliveryWrapper;
          ...
          final taskData = state.householdMemberDeliveryWrapper.tasks
              ?.where((element) =>
          ...
          if (DeliverySingleton().projectType != null) {
            bloc.add(
              DeliverInterventionEvent.setActiveCycleDose(
                ...
                projectType: DeliverySingleton().projectType!,
              ),
            );
          }
                      ...
                      body: ScrollableContent(
                        ...
                        footer: BlocBuilder<DeliverInterventionBloc,
                          ...
                          builder: (context, deliverState) {
                            final projectType = DeliverySingleton().projectType;
                        ...
                        children: [
                          ...
                          if ((DeliverySingleton().projectType?.cycles ?? [])
                              .isNotEmpty)
                            DigitCard(
                                margin: const EdgeInsets.all(spacer2),
                                children:
                                    DeliverySingleton().projectType?.cycles !=
                                            null
                                        ? [
