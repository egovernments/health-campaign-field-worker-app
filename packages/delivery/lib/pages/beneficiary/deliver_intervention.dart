...
// Initialize the currentStep variable to keep track of the current step in a process.
  ...
  Future<void> handleCapturedLocationState(
      ...
      FormGroup form,
      HouseholdMemberDeliveryWrapper householdMember,
    ...
    context.read<DeliverInterventionBloc>().add(
          DeliverInterventionSubmitEvent(
              task: _getTaskModel(
                context,
                form: form,
                oldTask: DeliverySingleton().beneficiaryType ==
              ...
              isEditing: (deliverInterventionState.tasks ?? []).isNotEmpty &&
                  ...
                  ? true
                  : false,
              boundaryModel: DeliverySingleton().boundary!,
            ...
            body: state.loading
                ...
                : BlocBuilder<DeliverInterventionBloc,
                    ...
                    builder: (context, deliveryInterventionState) {
                      ...
                      final int numberOfDoses = (DeliverySingleton()
                                  .projectType
                                  ?.cycles
                                  ?.isNotEmpty ==
                              true)
      ...
      additionalFields: TaskAdditionalFields(
        ...
        fields: [
          AdditionalField(
            ...
            DeliverySingleton().loggedInUser?.name,
          ),
          AdditionalField(
...
// This method builds a form used for delivering interventions.
  ...
  FormGroup buildForm(
    ...
    final overViewbloc = context.read<HouseholdOverviewDeliveryBloc>().state;
    ...
    if (_controllers.isEmpty) {
      final int r = DeliverySingleton()
          ...
          : fetchProductVariant(
                      ...
                      overViewbloc.householdMemberDeliveryWrapper.household)
                  ?.productVariants
                  ?.length ??
              0;
    ...
    return fb.group(<String, Object>{
      ...
      _deliveryCommentKey: FormControl<String>(
        value: DeliverySingleton().beneficiaryType != BeneficiaryType.individual
      ...
      _quantityDistributedKey: FormArray<int>([
        ..._controllers.mapIndexed(
          (i, e) => FormControl<int>(
            value: DeliverySingleton().beneficiaryType !=
                    BeneficiaryType.individual
                ? int.tryParse(
