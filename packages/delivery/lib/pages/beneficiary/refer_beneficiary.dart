...
import 'package:registration/widgets/inventory/no_facilities_assigned_dialog.dart';
...
class ReferBeneficiaryPageState extends LocalizedState<ReferBeneficiaryPage> {
  ...
  @override
  void initState() {
    reasons = (DeliverySingleton().referralReasons ?? [])
        .map((e) => KeyValue(e, e))
        .toList();
    super.initState();
  }
                          ...
                          onPressed: () {
                            ...
                            if (!form.valid) {
                              ...
                              final recipientId = selectedProjectFacilityId ==
                                      'Community Health Worker'
                                  ? DeliverySingleton().loggedInUserUuid
                                  ...
                                  additionalFields: ReferralAdditionalFields(
                                    ...
                                    fields: [
                                      AdditionalField("boundaryCode",
                                          DeliverySingleton().boundary?.code),
                              ...
                              final reloadState =
                                  context.read<HouseholdOverviewDeliveryBloc>();
  ...
  FormGroup buildForm() {
    return fb.group(<String, Object>{
      ...
      _administrativeUnitKey: FormControl<String>(
          value: localizations
              .translate(DeliverySingleton().boundary!.name.toString())),
      _referredByKey: FormControl<String>(
        value: DeliverySingleton().loggedInUserUuid,
