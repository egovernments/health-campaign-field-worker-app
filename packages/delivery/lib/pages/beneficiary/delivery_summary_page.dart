...
import '../../router/delivery_router.gm.dart';
                        ...
                        return DigitCard(
                            ...
                            children: [
                              LabelValueSummary(
                                  padding: EdgeInsets.zero,
                                  heading: localizations.translate(
                                      '${DeliverySingleton().selectedProject?.projectType?.toUpperCase()}_${i18.deliverIntervention.deliveryDetailsLabel}_${deliverState.oldTask?.status}'),
                                  headingStyle: textTheme.headingL.copyWith(
                                    color: theme.colorTheme.primary.primary2,
                                  ),
                                  withDivider: false,
                                  items: [
                                    LabelValueItem(
                                      label: localizations.translate(deliverState
                                          ...
                                          : '${DeliverySingleton().selectedProject?.projectType?.toUpperCase()}_${i18.deliverIntervention.typeOfResourceUsed}'),
