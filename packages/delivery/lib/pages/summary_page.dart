...
import 'package:registration/widgets/back_navigation_help_header.dart';
...
@RoutePage()
class SummaryDeliveryPage extends LocalizedStatefulWidget {
  const SummaryDeliveryPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<SummaryDeliveryPage> createState() => SummaryDeliveryPageState();
}

class SummaryDeliveryPageState extends LocalizedState<SummaryDeliveryPage> {
      ...
      onPopInvoked: (val) {
        context.read<BeneficiaryRegistrationBloc>().add(
              BeneficiaryRegistrationCreateEvent(
                ...
                userUuid: DeliverySingleton().loggedInUserUuid!,
                boundary: DeliverySingleton().boundary!,
              ),
            );
      },
      child: Scaffold(
                      ...
                      builder: (context, bool isClicked, _) {
                        return DigitButton(
                          ...
                          onPressed: () async {
                            ...
                            final userId = DeliverySingleton().loggedInUserUuid;
                            final projectId = DeliverySingleton().projectId;
