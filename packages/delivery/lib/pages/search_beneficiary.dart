...
@RoutePage()
class SearchBeneficiaryDeliveryPage extends LocalizedStatefulWidget {
  const SearchBeneficiaryDeliveryPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<SearchBeneficiaryDeliveryPage> createState() =>
      _SearchBeneficiaryDeliveryPageState();
}

class _SearchBeneficiaryDeliveryPageState
    extends LocalizedState<SearchBeneficiaryDeliveryPage> {
  ...
  late final SearchBlocDeliveryWrapper blocWrapper; // Declare BlocWrapper

  @override
  void initState() {
    // Initialize the BlocWrapper with instances of SearchHouseholdsBloc, SearchMemberBloc, and ProximitySearchBloc
    blocWrapper = context.read<SearchBlocDeliveryWrapper>();
    ...
    return KeyboardVisibilityBuilder(
      builder: (context, isKeyboardVisible) => Scaffold(
                    ...
                    children: [
                        ...
                        child: Align(
                          ...
                          child: Text(
                            localizations.translate(
                              DeliverySingleton().householdType != null &&
                        ...
                        builder: (context, locationState) {
                          return Column(
                            ...
                            children: [
                              ...
                              DeliverySingleton().searchHouseHoldFilter !=
                                          null &&
                                      DeliverySingleton()
                      ...
                      if (searchHouseholdsState.resultsNotFound &&
                        ...
                        Padding(
                          ...
                          child: InfoCard(
                            type: InfoType.info,
                            description: (DeliverySingleton().householdType ==
                                    HouseholdType.community)
                                ? localizations.translate(
              ...
              BlocListener<DigitScannerBloc, DigitScannerState>(
                listener: (context, scannerState) {
                  if (scannerState.qrCodes.isNotEmpty) {
                    context.read<SearchBlocDeliveryWrapper>().tagSearchBloc.add(
                                              ...
                                              projectBeneficiaryModel:
                                                  (i.projectBeneficiaries ?? [])
                                                      ...
                                                      ? i.projectBeneficiaries
                                                          ?.lastOrNull
                                                      : null,
                                              addressModel: (DeliverySingleton()
                                                          .householdType ==
                                                      HouseholdType.community)
                                                  ? i.household!.address!
                                                  : i.headOfHousehold!.address!
                                                      .lastOrNull!,
                                              headOfHousehold:
                                                  i.headOfHousehold),
                                    ),
        ...
        bottomNavigationBar: Offstage(
          offstage:
              DeliverySingleton().householdType == HouseholdType.community &&
    ...
    if (DeliverySingleton().beneficiaryType == BeneficiaryType.individual) {
      if (isProximityEnabled ||
        ...
        blocWrapper.individualGlobalSearchBloc
          ...
          projectId: DeliverySingleton().projectId!,
          longitude: long,
          maxRadius: DeliverySingleton().maxRadius,
