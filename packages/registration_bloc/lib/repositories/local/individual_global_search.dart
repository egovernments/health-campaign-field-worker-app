...
class IndividualGlobalSearchRepository extends LocalRepository {
  ...
  proximitySearch(
    ...
    if (params.isProximityEnabled == null || params.isProximityEnabled == false) {
      return null;
    } else if (params.isProximityEnabled !=null && params.isProximityEnabled ==true) {
      ...
      if (filter == Status.registered.name ||
        ...
        selectQuery = sql.individual.select().join([
          ...
          leftOuterJoin(
              ...
              sql.householdMember.individualClientReferenceId
                  .equalsExp(sql.individual.clientReferenceId)),
          if (params.nameSearch == null || params.isProximityEnabled==null || params.isProximityEnabled==false)
            leftOuterJoin(
                sql.projectBeneficiary,
                sql.projectBeneficiary.beneficiaryClientReferenceId
                    .equalsExp(sql.individual.clientReferenceId))
