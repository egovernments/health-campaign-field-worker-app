...
// ///
// /// This executor handles merging new additional fields into an existing entity.
// /// It's useful for update flows where you want to add/update specific fields
// /// in additionalFields without replacing the entire entity.
// ///
// /// Usage in config:
// /// ```json
// /// {
...
// ///     "collectFromPages": ["sideEffectFever", "sideEffectSick"],
// ///     "fieldsToMerge": ["feverQ1", "feverQ2"],
// ///     "fieldPrefix": "sideEffectFever",
// ///     "mainFieldsToUpdate": [
// ///       {"entityField": "symptom", "formField": "referralReason"}
// ///     ]
// ///   }
// /// }
// /// ```
