...
class _WarehouseDetailsPageState extends LocalizedState<WarehouseDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.projectId.isEmpty ? const Center(child: Text('No project selected')) : BlocConsumer<FacilityBloc, FacilityState>(
      ...
      builder: (ctx, facilityState) {
        final facilities = facilityState.whenOrNull(
          fetched: (facilities, _) {
            ...
            return widget.isDistributor! && !widget.isWareHouseMgr!
                ? teamFacilities
                : facilities;
          },
        ) ??
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              ...
                              // as StackRouter;
                              // final facility =
                              // await parent.push<InventoryFacilityModel>(
