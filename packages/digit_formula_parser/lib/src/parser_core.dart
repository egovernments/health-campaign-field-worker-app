...
final parser = () {
  ...
  builder.group().wrapper(char('(').trim(), char(')').trim(), (left, value, right) {
  ...
  builder.group()
    ...
    ..left(string('>=').trim(),
        (a, op, b) => mathFunction('GTE', [a, b]))
    ..left(string('==').trim(),
        (a, op, b) => mathFunction('EQ', [a, b]))
    ..left(string('!=').trim(),
        (a, op, b) => mathFunction('NE', [a, b]))
    ..left(char('<').trim(),
        (a, op, b) => mathFunction('LT', [a, b]))
    ..left(char('>').trim(),
        (a, op, b) => mathFunction('GT', [a, b]));
