...
import 'scanner_localization_delegate.dart';

// Class responsible for handling attendance localization
class ScannerLocalization {
  final Locale locale;
  final Future<dynamic> localizedStrings;
  final List<dynamic> languages;

  ScannerLocalization(this.locale, this.localizedStrings, this.languages);

  // Method to get the current localization instance from context
  static ScannerLocalization of(BuildContext context) {
    return Localizations.of<ScannerLocalization>(context, ScannerLocalization)!;
  }
  ...
  // scanner screen rendering hundreds of translated widgets against a
  ...
  static LocalizationsDelegate<ScannerLocalization> getDelegate(
          Future<dynamic> localizedStrings, List<dynamic> languages) =>
      ScannerLocalizationDelegate(localizedStrings, languages);
