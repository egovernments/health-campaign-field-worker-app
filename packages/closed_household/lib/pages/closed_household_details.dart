...
class ClosedHouseholdDetailsPage extends LocalizedStatefulWidget {
  ...
  @override
  State<ClosedHouseholdDetailsPage> createState() => _ClosedHouseholdDetailsPageState();
}

class _ClosedHouseholdDetailsPageState
  ...
  FormGroup buildForm(ClosedHouseholdState state) {
    ...
    return fb.group(<String, Object>{
      ...
      _latKey: FormControl<double>(value: state.userActions?.first.latitude, validators: [
      ]),
