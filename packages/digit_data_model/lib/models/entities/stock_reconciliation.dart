...
class StockReconciliationSearchModel extends EntitySearchModel
    with StockReconciliationSearchModelMappable {
  final String? id;
  ...
  int? get dateOfReconciliation =>
      dateOfReconciliationTime?.millisecondsSinceEpoch;
}

@MappableClass(ignoreNull: true, discriminatorValue: MappableClass.useAsDefault)
class StockReconciliationModel extends EntityModel
    with StockReconciliationModelMappable {
