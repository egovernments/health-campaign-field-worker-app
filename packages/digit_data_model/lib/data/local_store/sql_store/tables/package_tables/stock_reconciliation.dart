...
@TableIndex(name: 'stockrecon_clientref', columns: {#clientReferenceId})
@TableIndex(name: 'stockrecon_facilityid', columns: {#facilityId})
@TableIndex(name: 'stockrecon_productvariantid', columns: {#productVariantId})
