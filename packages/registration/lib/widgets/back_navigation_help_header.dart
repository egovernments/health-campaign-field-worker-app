...
import 'package:registration/widgets/showcase/showcase_button.dart';
    ...
    return Padding(
      ...
      child: Row(
        children: [
            ...
            child: Row(
              children: [
                if (showBackNavigation)
                  DigitBackButton(
                    label:
                        RegistrationLocalization.of(context).translate(
          ...
          if (showHelp)
            DigitButton(
              label: RegistrationLocalization.of(context)
