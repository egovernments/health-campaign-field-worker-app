    ...
    return KeyboardVisibilityBuilder(
      builder: (context, isKeyboardVisible) => Scaffold(
                    ...
                    children: [
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: DigitSearchBar(
                                  ...
                                  hintText: (RegistrationSingleton()
                                              .householdType ==
                                          HouseholdType.community)
                      ...
                      if (searchHouseholdsState.resultsNotFound &&
                        ...
                        Padding(
                          ...
                          child: InfoCard(
                            type: InfoType.info,
                            description: (RegistrationSingleton()
                                        .householdType ==
                                    HouseholdType.community)
                                ? localizations.translate(
        ...
        bottomNavigationBar: Offstage(
          offstage: RegistrationSingleton().householdType ==
                  HouseholdType.community &&
          ...
          child: DigitCard(
              ...
              children: [
                DigitButton(
                  ...
                  label: (RegistrationSingleton().householdType ==
                          HouseholdType.community)
                      ? localizations
    ...
    if (RegistrationSingleton().beneficiaryType ==
      ...
      if (isProximityEnabled ||
        ...
        blocWrapper.individualGlobalSearchBloc
          ...
          longitude: long,
          maxRadius: RegistrationSingleton().maxRadius,
          ...
          limit: isPagination
              ...
              : limit,
          householdType: RegistrationSingleton().householdType,
        )));
      }
    } else {
      if (isProximityEnabled ||
