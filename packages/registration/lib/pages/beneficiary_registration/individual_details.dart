...
class IndividualDetailsPageState extends LocalizedState<IndividualDetailsPage> {
                ...
                if (value.navigateToRoot) {
                  ...
                  overviewBloc.add(
                    HouseholdOverviewReloadEvent(
                      projectId:
                          RegistrationSingleton().projectId.toString(),
                      ...
                      builder: (context, bool isClicked, _) {
                        return DigitButton(
                          ...
                          onPressed: () async {
                            ...
                            final userId = RegistrationSingleton()
                                .loggedInUserUuid;
                            final projectId =
                                RegistrationSingleton().projectId;
                            ...
                            state.maybeWhen(
                              ...
                              create: (
                                ...
                                final boundary =
                                    RegistrationSingleton().boundary;
  ...
  IndividualModel _getIndividualModel(
    ...
    individual ??= IndividualModel(
      ...
      tenantId: RegistrationSingleton().tenantId,
      rowVersion: 1,
      auditDetails: AuditDetails(
        createdBy: RegistrationSingleton().loggedInUserUuid!,
        createdTime: context.millisecondsSinceEpoch(),
        lastModifiedBy: RegistrationSingleton().loggedInUserUuid,
    ...
    return fb.group(<String, Object>{
      _individualNameKey: FormControl<String>(
        ...
        value: individual?.name?.givenName ??
            ((RegistrationSingleton().householdType ==
                    HouseholdType.community)
                ? null
                : searchQuery?.trim()),
      ),
  ...
  getGenderOptions(IndividualModel? individual) {
    final options = RegistrationSingleton().genderOptions;
