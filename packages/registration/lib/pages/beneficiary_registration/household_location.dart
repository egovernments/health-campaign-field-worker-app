...
class HouseholdLocationPageState extends LocalizedState<HouseholdLocationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isCommunity = RegistrationSingleton().householdType ==
                            ...
                            registrationState.maybeWhen(
                              ...
                              create: (
                                ...
                                var addressModel = AddressModel(
                                  ...
                                  tenantId:
                                      RegistrationSingleton().tenantId,
                                  rowVersion: 1,
                                  buildingName: (RegistrationSingleton()
                                              .householdType ==
                                          HouseholdType.community)
                                      ? form.control(_buildingNameKey).value
                                      : null,
                                  auditDetails: AuditDetails(
                                    createdBy: RegistrationSingleton()
                                        .loggedInUserUuid!,
                                    createdTime:
  ...
  FormGroup buildForm(BeneficiaryRegistrationState state) {
    ...
    return fb.group(<String, Object>{
      _administrationAreaKey: FormControl<String>(
        value: localizations
            .translate(RegistrationSingleton().boundary!.code ?? ''),
