  ...
  Widget build(BuildContext context) {
    ...
    return KeyboardVisibilityBuilder(
      builder: (context, isKeyboardVisible) =>
          StreamBuilder<SearchHouseholdsState>(
        stream: blocWrapper.stateChanges,
              ...
              child: ScrollableContent(
                ...
                slivers: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: DigitChip(
                                                      label:
                                                          ...
                                                          ' (${searchHouseholdsState.data?.totalResults})',
                          ...
                          if (searchHouseholdsState.data != null &&
                              searchHouseholdsState
                                  .data!.householdMembers.isEmpty &&
                              !searchHouseholdsState.data!.loading)
                            Padding(
                  ...
                  BlocListener<UniqueIdBloc, UniqueIdState>(
                            ...
                            if (availableIdCount != 0 &&
                                    ...
                                    if (proceed) {
                                      ...
                                      context.router.push(
                                        ...
                                        initialState:
                                          ...
                                          searchQuery: searchHouseholdsState
                                              .data?.searchQuery,
                                        ),
                                      ));
                                      searchController.clear();
                              ...
                              context.router
                                ...
                                initialState:
                                    BeneficiaryRegistrationCreateState(
                                  searchQuery:
                                      searchHouseholdsState.data?.searchQuery,
                                ),
                              ));
                              searchController.clear();
                              selectedFilters = [];
                    ...
                    child: searchHouseholdsState.data != null
              ...
              child: DigitCard(
                  ...
                  children: [
                    DigitButton(
                      ...
                      type: DigitButtonType.primary,
                      size: DigitButtonSize.large,
                      isDisabled: (searchHouseholdsState.data?.searchQuery !=
                                      null &&
                                  searchHouseholdsState
                                      .data!.searchQuery!.isNotEmpty) ||
                              (searchHouseholdsState.data?.beneficiaryIdQuery !=
                                      null &&
                                  searchHouseholdsState
                                      .data!.beneficiaryIdQuery!.isNotEmpty)
                          ? false
                          : true,
                      onPressed: () {
                        if (!RegistrationDeliverySingleton()
                            .idTypeOptions!
                            .contains(IdentifierTypes.uniqueBeneficiaryID
                                .toValue())) {
                          FocusManager.instance.primaryFocus?.unfocus();
                          context.read<DigitScannerBloc>().add(
                                const DigitScannerEvent.handleScanner(),
