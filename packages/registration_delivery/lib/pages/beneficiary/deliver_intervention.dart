                                                    ...
                                                    children: [
                                                      ...
                                                      Center(
                                                        child: DigitIconButton(
                                                          onPressed: ((form.control(_resourceDeliveredKey) as FormArray)
                                                                              .value ??
                                                                          [])
                                                                      .length <
                                                                  (productVariants ??
                                                          ...
                                                          icon:
                                                              Icons.add_circle,
                                                          iconColor: ((form.control(_resourceDeliveredKey) as FormArray)
                                                                              .value ??
                                                                          [])
                                                                      .length <
                                                                  (productVariants ??
                                                              ...
                                                              : theme
                                                                  .colorScheme
                                                                  .outline,
                                                          iconTextColor: ((form.control(_resourceDeliveredKey) as FormArray)
                                                                              .value ??
                                                                          [])
                                                                      .length <
                                                                  (productVariants ??
