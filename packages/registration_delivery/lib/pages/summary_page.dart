                ...
                SliverToBoxAdapter(
                          ...
                          if (value != null &&
                            ...
                            final localizedValue = value.contains('.')
                                ? value
                                    .split('.')
                                    .map((part) =>
                                        localizations.translate(part.trim()))
                                    .join(', ')
                              ...
                              LabelValueItem(
                                  label: (isCommunity)
                                      ? localizations.translate(i18
                                          .beneficiaryDetails.totalCLFMembers)
                                      : localizations.translate(
                  ...
                  DigitCard(margin: const EdgeInsets.all(spacer2), children: [
                    LabelValueSummary(
                        ...
                        heading: (isCommunity)
                            ? localizations.translate(
                                i18.householdDetails.clfStructureDetailsLabel)
                            : localizations.translate(
                        ...
                        items: [
                          LabelValueItem(
                              label: (isCommunity)
                                  ? localizations.translate(
                                      i18.householdDetails.noOfRoomsCLFLabel)
                                  : localizations.translate(
