...
import '../../../../models/entities/text.dart';
import '../../../../models/entities/test_type.dart';
...
class Test extends Table {
  ...
  BoolColumn get nonRecoverableError => boolean().withDefault(const Constant(false))();
  TextColumn get tenantId => text().nullable()();
  IntColumn get rowVersion => integer().nullable()();
  IntColumn get type => intEnum<Text>().nullable()();
  ...
  IntColumn get type => intEnum<TestType>().nullable()();
