...
class AttendanceRegisterSearchModelMapper extends BaseMapper<AttendanceRegisterSearchModel> {
  ...
  AttendanceRegisterSearchModel fromMap(Map<String, dynamic> map) => AttendanceRegisterSearchModel.ignoreDeleted(id: Mapper.i.$getOpt(map, 'id'), clientReferenceId: Mapper.i.$getOpt(map, 'clientReferenceId'), staff: Mapper.i.$getOpt(map, 'staff'), attendees: Mapper.i.$getOpt(map, 'attendees'));
  ...
  @override String stringify(AttendanceRegisterSearchModel self) => 'AttendanceRegisterSearchModel(id: ${Mapper.asString(self.id)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, staff: ${Mapper.asString(self.staff)}, attendees: ${Mapper.asString(self.attendees)})';
  @override int hash(AttendanceRegisterSearchModel self) => Mapper.hash(self.id) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.staff) ^ Mapper.hash(self.attendees);
  @override bool equals(AttendanceRegisterSearchModel self, AttendanceRegisterSearchModel other) => Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.staff, other.staff) && Mapper.isEqual(self.attendees, other.attendees);
...
abstract class AttendanceRegisterSearchModelCopyWith<$R> {
  ...
  $R call({String? id, List<String>? clientReferenceId, List<StaffSearchModel>? staff, List<AttendeeSearchModel>? attendees});
...
class _AttendanceRegisterSearchModelCopyWithImpl<$R> extends BaseCopyWith<AttendanceRegisterSearchModel, $R> implements AttendanceRegisterSearchModelCopyWith<$R> {
  ...
  @override $R call({Object? id = $none, Object? clientReferenceId = $none, Object? staff = $none, Object? attendees = $none}) => $then(AttendanceRegisterSearchModel.ignoreDeleted(id: or(id, $value.id), clientReferenceId: or(clientReferenceId, $value.clientReferenceId), staff: or(staff, $value.staff), attendees: or(attendees, $value.attendees)));
}
...
class AttendancePackageRegisterModelMapper extends BaseMapper<AttendancePackageRegisterModel> {
  ...
  AttendancePackageRegisterModel fromMap(Map<String, dynamic> map) => AttendancePackageRegisterModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$getOpt(map, 'id'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), registerNumber: Mapper.i.$getOpt(map, 'registerNumber'), name: Mapper.i.$getOpt(map, 'name'), referenceId: Mapper.i.$getOpt(map, 'referenceId'), serviceCode: Mapper.i.$getOpt(map, 'serviceCode'), status: Mapper.i.$getOpt(map, 'status'), nonRecoverableError: Mapper.i.$getOpt(map, 'nonRecoverableError') ?? false, clientReferenceId: Mapper.i.$get(map, 'clientReferenceId'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), staff: Mapper.i.$getOpt(map, 'staff'), attendees: Mapper.i.$getOpt(map, 'attendees'), startDate: Mapper.i.$getOpt(map, 'startDate'), endDate: Mapper.i.$getOpt(map, 'endDate'));
  ...
  Map<String, dynamic> toMap(AttendancePackageRegisterModel a) => {if (Mapper.i.$enc(a.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(a.additionalFields, 'additionalFields'), if (Mapper.i.$enc(a.id, 'id') != null) 'id': Mapper.i.$enc(a.id, 'id'), if (Mapper.i.$enc(a.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(a.tenantId, 'tenantId'), if (Mapper.i.$enc(a.registerNumber, 'registerNumber') != null) 'registerNumber': Mapper.i.$enc(a.registerNumber, 'registerNumber'), if (Mapper.i.$enc(a.name, 'name') != null) 'name': Mapper.i.$enc(a.name, 'name'), if (Mapper.i.$enc(a.referenceId, 'referenceId') != null) 'referenceId': Mapper.i.$enc(a.referenceId, 'referenceId'), if (Mapper.i.$enc(a.serviceCode, 'serviceCode') != null) 'serviceCode': Mapper.i.$enc(a.serviceCode, 'serviceCode'), if (Mapper.i.$enc(a.status, 'status') != null) 'status': Mapper.i.$enc(a.status, 'status'), if (Mapper.i.$enc(a.nonRecoverableError, 'nonRecoverableError') != null) 'nonRecoverableError': Mapper.i.$enc(a.nonRecoverableError, 'nonRecoverableError'), 'clientReferenceId': Mapper.i.$enc(a.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(a.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(a.rowVersion, 'rowVersion'), if (Mapper.i.$enc(a.staff, 'staff') != null) 'staff': Mapper.i.$enc(a.staff, 'staff'), if (Mapper.i.$enc(a.attendees, 'attendees') != null) 'attendees': Mapper.i.$enc(a.attendees, 'attendees'), if (Mapper.i.$enc(a.startDate, 'startDate') != null) 'startDate': Mapper.i.$enc(a.startDate, 'startDate'), if (Mapper.i.$enc(a.endDate, 'endDate') != null) 'endDate': Mapper.i.$enc(a.endDate, 'endDate')};
...
abstract class AttendancePackageRegisterModelCopyWith<$R> {
  ...
  $R call({AttendanceRegisterAdditionalFields? additionalFields, String? id, String? tenantId, String? registerNumber, String? name, String? referenceId, String? serviceCode, String? status, bool? nonRecoverableError, String? clientReferenceId, int? rowVersion, List<StaffModel>? staff, List<AttendeeModel>? attendees, int? startDate, int? endDate});
...
class StaffSearchModelMapper extends BaseMapper<StaffSearchModel> {
  ...
  StaffSearchModel fromMap(Map<String, dynamic> map) => StaffSearchModel.ignoreDeleted(id: Mapper.i.$getOpt(map, 'id'), clientReferenceId: Mapper.i.$getOpt(map, 'clientReferenceId'));

  @override Function get encoder => (StaffSearchModel v) => encode(v);
  dynamic encode(StaffSearchModel v) => toMap(v);
  Map<String, dynamic> toMap(StaffSearchModel s) => {if (Mapper.i.$enc(s.id, 'id') != null) 'id': Mapper.i.$enc(s.id, 'id'), if (Mapper.i.$enc(s.clientReferenceId, 'clientReferenceId') != null) 'clientReferenceId': Mapper.i.$enc(s.clientReferenceId, 'clientReferenceId')};

  @override String stringify(StaffSearchModel self) => 'StaffSearchModel(id: ${Mapper.asString(self.id)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)})';
  @override int hash(StaffSearchModel self) => Mapper.hash(self.id) ^ Mapper.hash(self.clientReferenceId);
  @override bool equals(StaffSearchModel self, StaffSearchModel other) => Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId);
...
class _StaffSearchModelCopyWithImpl<$R> extends BaseCopyWith<StaffSearchModel, $R> implements StaffSearchModelCopyWith<$R> {
  ...
  @override $R call({Object? id = $none, Object? clientReferenceId = $none}) => $then(StaffSearchModel.ignoreDeleted(id: or(id, $value.id), clientReferenceId: or(clientReferenceId, $value.clientReferenceId)));
}
