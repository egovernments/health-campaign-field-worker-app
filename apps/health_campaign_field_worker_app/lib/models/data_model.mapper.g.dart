...
class HouseholdMemberSearchModelMapper extends BaseMapper<HouseholdMemberSearchModel> {
  ...
  HouseholdMemberSearchModel fromMap(Map<String, dynamic> map) => HouseholdMemberSearchModel.ignoreDeleted(id: Mapper.i.$getOpt(map, 'id'), householdId: Mapper.i.$getOpt(map, 'householdId'), householdClientReferenceId: Mapper.i.$getOpt(map, 'householdClientReferenceId'), householdClientReferenceIds: Mapper.i.$getOpt(map, 'householdClientReferenceIds'), individualId: Mapper.i.$getOpt(map, 'individualId'), individualClientReferenceId: Mapper.i.$getOpt(map, 'individualClientReferenceId'), individualClientReferenceIds: Mapper.i.$getOpt(map, 'individualClientReferenceIds'), isHeadOfHousehold: Mapper.i.$getOpt(map, 'isHeadOfHousehold'), clientReferenceId: Mapper.i.$getOpt(map, 'clientReferenceId'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), boundaryCode: Mapper.i.$getOpt(map, 'boundaryCode'));

  @override Function get encoder => (HouseholdMemberSearchModel v) => encode(v);
  dynamic encode(HouseholdMemberSearchModel v) => toMap(v);
  Map<String, dynamic> toMap(HouseholdMemberSearchModel h) => {if (Mapper.i.$enc(h.id, 'id') != null) 'id': Mapper.i.$enc(h.id, 'id'), if (Mapper.i.$enc(h.householdId, 'householdId') != null) 'householdId': Mapper.i.$enc(h.householdId, 'householdId'), if (Mapper.i.$enc(h.householdClientReferenceId, 'householdClientReferenceId') != null) 'householdClientReferenceId': Mapper.i.$enc(h.householdClientReferenceId, 'householdClientReferenceId'), if (Mapper.i.$enc(h.householdClientReferenceIds, 'householdClientReferenceIds') != null) 'householdClientReferenceIds': Mapper.i.$enc(h.householdClientReferenceIds, 'householdClientReferenceIds'), if (Mapper.i.$enc(h.individualId, 'individualId') != null) 'individualId': Mapper.i.$enc(h.individualId, 'individualId'), if (Mapper.i.$enc(h.individualClientReferenceId, 'individualClientReferenceId') != null) 'individualClientReferenceId': Mapper.i.$enc(h.individualClientReferenceId, 'individualClientReferenceId'), if (Mapper.i.$enc(h.individualClientReferenceIds, 'individualClientReferenceIds') != null) 'individualClientReferenceIds': Mapper.i.$enc(h.individualClientReferenceIds, 'individualClientReferenceIds'), if (Mapper.i.$enc(h.isHeadOfHousehold, 'isHeadOfHousehold') != null) 'isHeadOfHousehold': Mapper.i.$enc(h.isHeadOfHousehold, 'isHeadOfHousehold'), if (Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId') != null) 'clientReferenceId': Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(h.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(h.tenantId, 'tenantId'), if (Mapper.i.$enc(h.boundaryCode, 'boundaryCode') != null) 'boundaryCode': Mapper.i.$enc(h.boundaryCode, 'boundaryCode')};

  @override String stringify(HouseholdMemberSearchModel self) => 'HouseholdMemberSearchModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, additionalFields: ${Mapper.asString(self.additionalFields)}, id: ${Mapper.asString(self.id)}, householdId: ${Mapper.asString(self.householdId)}, householdClientReferenceId: ${Mapper.asString(self.householdClientReferenceId)}, householdClientReferenceIds: ${Mapper.asString(self.householdClientReferenceIds)}, individualId: ${Mapper.asString(self.individualId)}, individualClientReferenceId: ${Mapper.asString(self.individualClientReferenceId)}, isHeadOfHousehold: ${Mapper.asString(self.isHeadOfHousehold)}, individualClientReferenceIds: ${Mapper.asString(self.individualClientReferenceIds)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, tenantId: ${Mapper.asString(self.tenantId)})';
  @override int hash(HouseholdMemberSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.householdId) ^ Mapper.hash(self.householdClientReferenceId) ^ Mapper.hash(self.householdClientReferenceIds) ^ Mapper.hash(self.individualId) ^ Mapper.hash(self.individualClientReferenceId) ^ Mapper.hash(self.isHeadOfHousehold) ^ Mapper.hash(self.individualClientReferenceIds) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId);
  @override bool equals(HouseholdMemberSearchModel self, HouseholdMemberSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.householdId, other.householdId) && Mapper.isEqual(self.householdClientReferenceId, other.householdClientReferenceId) && Mapper.isEqual(self.householdClientReferenceIds, other.householdClientReferenceIds) && Mapper.isEqual(self.individualId, other.individualId) && Mapper.isEqual(self.individualClientReferenceId, other.individualClientReferenceId) && Mapper.isEqual(self.isHeadOfHousehold, other.isHeadOfHousehold) && Mapper.isEqual(self.individualClientReferenceIds, other.individualClientReferenceIds) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId);
...
abstract class HouseholdMemberSearchModelCopyWith<$R> {
  ...
  $R call({String? id, String? householdId, String? householdClientReferenceId, List<String>? householdClientReferenceIds, String? individualId, String? individualClientReferenceId, List<String>? individualClientReferenceIds, bool? isHeadOfHousehold, List<String>? clientReferenceId, String? tenantId, String? boundaryCode});
...
class _HouseholdMemberSearchModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdMemberSearchModel, $R> implements HouseholdMemberSearchModelCopyWith<$R> {
  ...
  @override $R call({Object? id = $none, Object? householdId = $none, Object? householdClientReferenceId = $none, Object? householdClientReferenceIds = $none, Object? individualId = $none, Object? individualClientReferenceId = $none, Object? individualClientReferenceIds = $none, Object? isHeadOfHousehold = $none, Object? clientReferenceId = $none, Object? tenantId = $none, Object? boundaryCode = $none}) => $then(HouseholdMemberSearchModel.ignoreDeleted(id: or(id, $value.id), householdId: or(householdId, $value.householdId), householdClientReferenceId: or(householdClientReferenceId, $value.householdClientReferenceId), householdClientReferenceIds: or(householdClientReferenceIds, $value.householdClientReferenceIds), individualId: or(individualId, $value.individualId), individualClientReferenceId: or(individualClientReferenceId, $value.individualClientReferenceId), individualClientReferenceIds: or(individualClientReferenceIds, $value.individualClientReferenceIds), isHeadOfHousehold: or(isHeadOfHousehold, $value.isHeadOfHousehold), clientReferenceId: or(clientReferenceId, $value.clientReferenceId), tenantId: or(tenantId, $value.tenantId), boundaryCode: or(boundaryCode, $value.boundaryCode)));
}
