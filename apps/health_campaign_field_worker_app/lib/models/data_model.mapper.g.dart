...
class _StockModelCopyWithImpl<$R> extends BaseCopyWith<StockModel, $R> implements StockModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? tenantId = $none, Object? facilityId = $none, Object? productVariantId = $none, Object? referenceId = $none, Object? referenceIdType = $none, Object? transactingPartyId = $none, Object? transactingPartyType = $none, Object? receiverId = $none, Object? receiverType = $none, Object? senderId = $none, Object? senderType = $none, Object? quantity = $none, Object? waybillNumber = $none, String? clientReferenceId, Object? rowVersion = $none, Object? transactionType = $none, Object? transactionReason = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(StockModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), tenantId: or(tenantId, $value.tenantId), facilityId: or(facilityId, $value.facilityId), productVariantId: or(productVariantId, $value.productVariantId), referenceId: or(referenceId, $value.referenceId), referenceIdType: or(referenceIdType, $value.referenceIdType), transactingPartyId: or(transactingPartyId, $value.transactingPartyId), transactingPartyType: or(transactingPartyType, $value.transactingPartyType), receiverId: or(receiverId, $value.receiverId), receiverType: or(receiverType, $value.receiverType), senderId: or(senderId, $value.senderId), senderType: or(senderType, $value.senderType), quantity: or(quantity, $value.quantity), waybillNumber: or(waybillNumber, $value.waybillNumber), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, rowVersion: or(rowVersion, $value.rowVersion), transactionType: or(transactionType, $value.transactionType), transactionReason: or(transactionReason, $value.transactionReason), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
