...
class AddressSearchModelMapper extends BaseMapper<AddressSearchModel> {
  ...
  @override int hash(AddressSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(AddressSearchModel self, AddressSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class AttributesSearchModelMapper extends BaseMapper<AttributesSearchModel> {
  ...
  @override int hash(AttributesSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.dataType) ^ Mapper.hash(self.referenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.required) ^ Mapper.hash(self.regex) ^ Mapper.hash(self.order) ^ Mapper.hash(self.isDeleted);
  @override bool equals(AttributesSearchModel self, AttributesSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.dataType, other.dataType) && Mapper.isEqual(self.referenceId, other.referenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.required, other.required) && Mapper.isEqual(self.regex, other.regex) && Mapper.isEqual(self.order, other.order) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class AttributesModelMapper extends BaseMapper<AttributesModel> {
  ...
  @override String stringify(AttributesModel self) => 'AttributesModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, dataType: ${Mapper.asString(self.dataType)}, referenceId: ${Mapper.asString(self.referenceId)}, tenantId: ${Mapper.asString(self.tenantId)}, code: ${Mapper.asString(self.code)}, values: ${Mapper.asString(self.values)}, isActive: ${Mapper.asString(self.isActive)}, required: ${Mapper.asString(self.required)}, regex: ${Mapper.asString(self.regex)}, order: ${Mapper.asString(self.order)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(AttributesModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.dataType) ^ Mapper.hash(self.referenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.values) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.required) ^ Mapper.hash(self.regex) ^ Mapper.hash(self.order) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(AttributesModel self, AttributesModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.dataType, other.dataType) && Mapper.isEqual(self.referenceId, other.referenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.values, other.values) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.required, other.required) && Mapper.isEqual(self.regex, other.regex) && Mapper.isEqual(self.order, other.order) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class DocumentSearchModelMapper extends BaseMapper<DocumentSearchModel> {
  ...
  @override int hash(DocumentSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(DocumentSearchModel self, DocumentSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class DocumentModelMapper extends BaseMapper<DocumentModel> {
  ...
  @override int hash(DocumentModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.documentType) ^ Mapper.hash(self.fileStoreId) ^ Mapper.hash(self.documentUid) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(DocumentModel self, DocumentModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.documentType, other.documentType) && Mapper.isEqual(self.fileStoreId, other.fileStoreId) && Mapper.isEqual(self.documentUid, other.documentUid) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class HouseholdSearchModelMapper extends BaseMapper<HouseholdSearchModel> {
  ...
  @override int hash(HouseholdSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.memberCount) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(HouseholdSearchModel self, HouseholdSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.memberCount, other.memberCount) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class HouseholdModelMapper extends BaseMapper<HouseholdModel> {
  ...
  @override int hash(HouseholdModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.memberCount) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.address) ^ Mapper.hash(self.additionalFields);
  @override bool equals(HouseholdModel self, HouseholdModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.memberCount, other.memberCount) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.address, other.address) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class IdentifierSearchModelMapper extends BaseMapper<IdentifierSearchModel> {
  ...
  @override int hash(IdentifierSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.identifierType) ^ Mapper.hash(self.identifierId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(IdentifierSearchModel self, IdentifierSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.identifierType, other.identifierType) && Mapper.isEqual(self.identifierId, other.identifierId) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class IdentifierModelMapper extends BaseMapper<IdentifierModel> {
  ...
  @override int hash(IdentifierModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.identifierType) ^ Mapper.hash(self.identifierId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(IdentifierModel self, IdentifierModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.identifierType, other.identifierType) && Mapper.isEqual(self.identifierId, other.identifierId) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class IndividualSearchModelMapper extends BaseMapper<IndividualSearchModel> {
  ...
  @override int hash(IndividualSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.dateOfBirth) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.name) ^ Mapper.hash(self.gender) ^ Mapper.hash(self.identifiers);
  @override bool equals(IndividualSearchModel self, IndividualSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.dateOfBirth, other.dateOfBirth) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.gender, other.gender) && Mapper.isEqual(self.identifiers, other.identifiers);
...
class LocalitySearchModelMapper extends BaseMapper<LocalitySearchModel> {
  ...
  @override int hash(LocalitySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.code) ^ Mapper.hash(self.name) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(LocalitySearchModel self, LocalitySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class LocalityModelMapper extends BaseMapper<LocalityModel> {
  ...
  @override int hash(LocalityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.code) ^ Mapper.hash(self.name) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(LocalityModel self, LocalityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class NameSearchModelMapper extends BaseMapper<NameSearchModel> {
  ...
  @override int hash(NameSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.givenName) ^ Mapper.hash(self.familyName) ^ Mapper.hash(self.otherNames) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(NameSearchModel self, NameSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.givenName, other.givenName) && Mapper.isEqual(self.familyName, other.familyName) && Mapper.isEqual(self.otherNames, other.otherNames) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class NameModelMapper extends BaseMapper<NameModel> {
  ...
  @override String stringify(NameModel self) => 'NameModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, individualClientReferenceId: ${Mapper.asString(self.individualClientReferenceId)}, givenName: ${Mapper.asString(self.givenName)}, familyName: ${Mapper.asString(self.familyName)}, otherNames: ${Mapper.asString(self.otherNames)}, tenantId: ${Mapper.asString(self.tenantId)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(NameModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.individualClientReferenceId) ^ Mapper.hash(self.givenName) ^ Mapper.hash(self.familyName) ^ Mapper.hash(self.otherNames) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(NameModel self, NameModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.individualClientReferenceId, other.individualClientReferenceId) && Mapper.isEqual(self.givenName, other.givenName) && Mapper.isEqual(self.familyName, other.familyName) && Mapper.isEqual(self.otherNames, other.otherNames) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class ProductSearchModelMapper extends BaseMapper<ProductSearchModel> {
  ...
  @override int hash(ProductSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.type) ^ Mapper.hash(self.name) ^ Mapper.hash(self.manufacturer) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(ProductSearchModel self, ProductSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.type, other.type) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.manufacturer, other.manufacturer) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class ProductModelMapper extends BaseMapper<ProductModel> {
  ...
  @override int hash(ProductModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.type) ^ Mapper.hash(self.name) ^ Mapper.hash(self.manufacturer) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProductModel self, ProductModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.type, other.type) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.manufacturer, other.manufacturer) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class ProductVariantSearchModelMapper extends BaseMapper<ProductVariantSearchModel> {
  ...
  @override int hash(ProductVariantSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.productId) ^ Mapper.hash(self.sku) ^ Mapper.hash(self.variation) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
...
class ProjectBeneficiarySearchModelMapper extends BaseMapper<ProjectBeneficiarySearchModel> {
  ...
  @override int hash(ProjectBeneficiarySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.beneficiaryId) ^ Mapper.hash(self.beneficiaryClientReferenceId) ^ Mapper.hash(self.beneficiaryRegistrationDateLte) ^ Mapper.hash(self.beneficiaryRegistrationDateGte) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.dateOfRegistrationTime);
...
abstract class ProjectBeneficiarySearchModelCopyWith<$R> {
  ...
  $R call({String? id, String? projectId, String? beneficiaryId, List<String>? beneficiaryClientReferenceId, DateTime? beneficiaryRegistrationDateLte, DateTime? beneficiaryRegistrationDateGte, List<String>? clientReferenceId, String? tenantId, bool? isDeleted, int? dateOfRegistration, String? boundaryCode});
...
class ProjectBeneficiaryModelMapper extends BaseMapper<ProjectBeneficiaryModel> {
  ...
  @override int hash(ProjectBeneficiaryModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.beneficiaryId) ^ Mapper.hash(self.beneficiaryClientReferenceId) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.dateOfRegistrationTime) ^ Mapper.hash(self.additionalFields);
...
class ProjectFacilitySearchModelMapper extends BaseMapper<ProjectFacilitySearchModel> {
  ...
  @override int hash(ProjectFacilitySearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.facilityId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(ProjectFacilitySearchModel self, ProjectFacilitySearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.facilityId, other.facilityId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class ProjectFacilityModelMapper extends BaseMapper<ProjectFacilityModel> {
  ...
  @override String stringify(ProjectFacilityModel self) => 'ProjectFacilityModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, facilityId: ${Mapper.asString(self.facilityId)}, projectId: ${Mapper.asString(self.projectId)}, tenantId: ${Mapper.asString(self.tenantId)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectFacilityModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.facilityId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectFacilityModel self, ProjectFacilityModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.facilityId, other.facilityId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class ProjectProductVariantSearchModelMapper extends BaseMapper<ProjectProductVariantSearchModel> {
  ...
  @override int hash(ProjectProductVariantSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.productVariantId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
...
class ProjectResourceSearchModelMapper extends BaseMapper<ProjectResourceSearchModel> {
  ...
  @override int hash(ProjectResourceSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(ProjectResourceSearchModel self, ProjectResourceSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class ProjectResourceModelMapper extends BaseMapper<ProjectResourceModel> {
  ...
  @override String stringify(ProjectResourceModel self) => 'ProjectResourceModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, projectId: ${Mapper.asString(self.projectId)}, tenantId: ${Mapper.asString(self.tenantId)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)}, resource: ${Mapper.asString(self.resource)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectResourceModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.resource) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectResourceModel self, ProjectResourceModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.resource, other.resource) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class ProjectStaffSearchModelMapper extends BaseMapper<ProjectStaffSearchModel> {
  ...
  @override int hash(ProjectStaffSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.staffId) ^ Mapper.hash(self.userId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.startDateTime) ^ Mapper.hash(self.endDateTime);
  @override bool equals(ProjectStaffSearchModel self, ProjectStaffSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.staffId, other.staffId) && Mapper.isEqual(self.userId, other.userId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.startDateTime, other.startDateTime) && Mapper.isEqual(self.endDateTime, other.endDateTime);
...
class ProjectStaffModelMapper extends BaseMapper<ProjectStaffModel> {
  ...
  @override String stringify(ProjectStaffModel self) => 'ProjectStaffModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, staffId: ${Mapper.asString(self.staffId)}, userId: ${Mapper.asString(self.userId)}, projectId: ${Mapper.asString(self.projectId)}, channel: ${Mapper.asString(self.channel)}, tenantId: ${Mapper.asString(self.tenantId)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)}, startDateTime: ${Mapper.asString(self.startDateTime)}, endDateTime: ${Mapper.asString(self.endDateTime)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ProjectStaffModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.staffId) ^ Mapper.hash(self.userId) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.channel) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.startDateTime) ^ Mapper.hash(self.endDateTime) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ProjectStaffModel self, ProjectStaffModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.staffId, other.staffId) && Mapper.isEqual(self.userId, other.userId) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.channel, other.channel) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.startDateTime, other.startDateTime) && Mapper.isEqual(self.endDateTime, other.endDateTime) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class ProjectTypeSearchModelMapper extends BaseMapper<ProjectTypeSearchModel> {
  ...
  @override int hash(ProjectTypeSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
...
class ServiceAttributesSearchModelMapper extends BaseMapper<ServiceAttributesSearchModel> {
  ...
  @override int hash(ServiceAttributesSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
...
class ServiceDefinitionSearchModelMapper extends BaseMapper<ServiceDefinitionSearchModel> {
  ...
  @override int hash(ServiceDefinitionSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.isDeleted);
  @override bool equals(ServiceDefinitionSearchModel self, ServiceDefinitionSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class ServiceDefinitionModelMapper extends BaseMapper<ServiceDefinitionModel> {
  ...
  @override String stringify(ServiceDefinitionModel self) => 'ServiceDefinitionModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, tenantId: ${Mapper.asString(self.tenantId)}, code: ${Mapper.asString(self.code)}, isActive: ${Mapper.asString(self.isActive)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)}, attributes: ${Mapper.asString(self.attributes)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(ServiceDefinitionModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.code) ^ Mapper.hash(self.isActive) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.attributes) ^ Mapper.hash(self.additionalFields);
  @override bool equals(ServiceDefinitionModel self, ServiceDefinitionModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.code, other.code) && Mapper.isEqual(self.isActive, other.isActive) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.attributes, other.attributes) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
class TargetSearchModelMapper extends BaseMapper<TargetSearchModel> {
  ...
  @override String stringify(TargetSearchModel self) => 'TargetSearchModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, additionalFields: ${Mapper.asString(self.additionalFields)}, tenantId: ${Mapper.asString(self.tenantId)}, isDeleted: ${Mapper.asString(self.isDeleted)})';
  @override int hash(TargetSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
  @override bool equals(TargetSearchModel self, TargetSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted);
...
class TargetModelMapper extends BaseMapper<TargetModel> {
  ...
  TargetModel fromMap(Map<String, dynamic> map) => TargetModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), clientReferenceId: Mapper.i.$getOpt(map, 'clientReferenceId'), totalNo: Mapper.i.$getOpt(map, 'totalNo'), targetNo: Mapper.i.$getOpt(map, 'targetNo'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), isDeleted: Mapper.i.$getOpt(map, 'isDeleted'), rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), beneficiaryType: Mapper.i.$getOpt(map, 'beneficiaryType'), auditDetails: Mapper.i.$getOpt(map, 'auditDetails'));

  @override Function get encoder => (TargetModel v) => encode(v);
  dynamic encode(TargetModel v) => toMap(v);
  Map<String, dynamic> toMap(TargetModel t) => {if (Mapper.i.$enc(t.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(t.additionalFields, 'additionalFields'), 'id': Mapper.i.$enc(t.id, 'id'), if (Mapper.i.$enc(t.clientReferenceId, 'clientReferenceId') != null) 'clientReferenceId': Mapper.i.$enc(t.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(t.totalNo, 'totalNo') != null) 'totalNo': Mapper.i.$enc(t.totalNo, 'totalNo'), if (Mapper.i.$enc(t.targetNo, 'targetNo') != null) 'targetNo': Mapper.i.$enc(t.targetNo, 'targetNo'), if (Mapper.i.$enc(t.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(t.tenantId, 'tenantId'), if (Mapper.i.$enc(t.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(t.isDeleted, 'isDeleted'), if (Mapper.i.$enc(t.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(t.rowVersion, 'rowVersion'), if (Mapper.i.$enc(t.beneficiaryType, 'beneficiaryType') != null) 'beneficiaryType': Mapper.i.$enc(t.beneficiaryType, 'beneficiaryType'), if (Mapper.i.$enc(t.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(t.auditDetails, 'auditDetails')};

  @override String stringify(TargetModel self) => 'TargetModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, id: ${Mapper.asString(self.id)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, totalNo: ${Mapper.asString(self.totalNo)}, targetNo: ${Mapper.asString(self.targetNo)}, tenantId: ${Mapper.asString(self.tenantId)}, isDeleted: ${Mapper.asString(self.isDeleted)}, rowVersion: ${Mapper.asString(self.rowVersion)}, beneficiaryType: ${Mapper.asString(self.beneficiaryType)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(TargetModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.totalNo) ^ Mapper.hash(self.targetNo) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.beneficiaryType) ^ Mapper.hash(self.additionalFields);
  @override bool equals(TargetModel self, TargetModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.totalNo, other.totalNo) && Mapper.isEqual(self.targetNo, other.targetNo) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.beneficiaryType, other.beneficiaryType) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class TargetModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({TargetAdditionalFields? additionalFields, String? id, String? clientReferenceId, double? totalNo, double? targetNo, String? tenantId, bool? isDeleted, int? rowVersion, BeneficiaryType? beneficiaryType, AuditDetails? auditDetails});
...
class _TargetModelCopyWithImpl<$R> extends BaseCopyWith<TargetModel, $R> implements TargetModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, String? id, Object? clientReferenceId = $none, Object? totalNo = $none, Object? targetNo = $none, Object? tenantId = $none, Object? isDeleted = $none, Object? rowVersion = $none, Object? beneficiaryType = $none, Object? auditDetails = $none}) => $then(TargetModel(additionalFields: or(additionalFields, $value.additionalFields), id: id ?? $value.id, clientReferenceId: or(clientReferenceId, $value.clientReferenceId), totalNo: or(totalNo, $value.totalNo), targetNo: or(targetNo, $value.targetNo), tenantId: or(tenantId, $value.tenantId), isDeleted: or(isDeleted, $value.isDeleted), rowVersion: or(rowVersion, $value.rowVersion), beneficiaryType: or(beneficiaryType, $value.beneficiaryType), auditDetails: or(auditDetails, $value.auditDetails)));
}
...
class TaskSearchModelMapper extends BaseMapper<TaskSearchModel> {
  ...
  @override int hash(TaskSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.projectBeneficiaryId) ^ Mapper.hash(self.projectBeneficiaryClientReferenceId) ^ Mapper.hash(self.createdBy) ^ Mapper.hash(self.status) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.plannedStartDateTime) ^ Mapper.hash(self.plannedEndDateTime) ^ Mapper.hash(self.actualStartDateTime) ^ Mapper.hash(self.actualEndDateTime);
...
abstract class TaskSearchModelCopyWith<$R> {
  ...
  $R call({String? id, String? projectId, String? projectBeneficiaryId, List<String>? projectBeneficiaryClientReferenceId, String? createdBy, String? status, List<String>? clientReferenceId, String? tenantId, bool? isDeleted, int? plannedStartDate, int? plannedEndDate, int? actualStartDate, int? actualEndDate, String? boundaryCode});
...
class TaskModelMapper extends BaseMapper<TaskModel> {
  ...
  @override int hash(TaskModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.projectBeneficiaryId) ^ Mapper.hash(self.projectBeneficiaryClientReferenceId) ^ Mapper.hash(self.createdBy) ^ Mapper.hash(self.status) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.resources) ^ Mapper.hash(self.address) ^ Mapper.hash(self.plannedStartDateTime) ^ Mapper.hash(self.plannedEndDateTime) ^ Mapper.hash(self.actualStartDateTime) ^ Mapper.hash(self.actualEndDateTime) ^ Mapper.hash(self.createdDateTime) ^ Mapper.hash(self.additionalFields);
...
class TaskResourceSearchModelMapper extends BaseMapper<TaskResourceSearchModel> {
  ...
  @override int hash(TaskResourceSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.isDeleted);
