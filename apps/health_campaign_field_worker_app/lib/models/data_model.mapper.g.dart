...
abstract class HFReferralSearchModelCopyWith<$R> {
  ...
  $R call({String? id, String? tenantId, String? name, String? projectId, String? facilityId, String? symptomSurveyId, String? beneficiaryId, String? referralCode, String? nationalLevelId, String? symptom, List<String>? clientReferenceId, String? boundaryCode});
...
class HFReferralModelMapper extends BaseMapper<HFReferralModel> {
  ...
  @override String stringify(HFReferralModel self) => 'HFReferralModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, clientAuditDetails: ${Mapper.asString(self.clientAuditDetails)}, id: ${Mapper.asString(self.id)}, tenantId: ${Mapper.asString(self.tenantId)}, name: ${Mapper.asString(self.name)}, projectId: ${Mapper.asString(self.projectId)}, facilityId: ${Mapper.asString(self.facilityId)}, symptomSurveyId: ${Mapper.asString(self.symptomSurveyId)}, beneficiaryId: ${Mapper.asString(self.beneficiaryId)}, referralCode: ${Mapper.asString(self.referralCode)}, nationalLevelId: ${Mapper.asString(self.nationalLevelId)}, symptom: ${Mapper.asString(self.symptom)}, nonRecoverableError: ${Mapper.asString(self.nonRecoverableError)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)}, rowVersion: ${Mapper.asString(self.rowVersion)}, additionalFields: ${Mapper.asString(self.additionalFields)})';
  @override int hash(HFReferralModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.clientAuditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.name) ^ Mapper.hash(self.projectId) ^ Mapper.hash(self.facilityId) ^ Mapper.hash(self.symptomSurveyId) ^ Mapper.hash(self.beneficiaryId) ^ Mapper.hash(self.referralCode) ^ Mapper.hash(self.nationalLevelId) ^ Mapper.hash(self.symptom) ^ Mapper.hash(self.nonRecoverableError) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(HFReferralModel self, HFReferralModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.clientAuditDetails, other.clientAuditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.projectId, other.projectId) && Mapper.isEqual(self.facilityId, other.facilityId) && Mapper.isEqual(self.symptomSurveyId, other.symptomSurveyId) && Mapper.isEqual(self.beneficiaryId, other.beneficiaryId) && Mapper.isEqual(self.referralCode, other.referralCode) && Mapper.isEqual(self.nationalLevelId, other.nationalLevelId) && Mapper.isEqual(self.symptom, other.symptom) && Mapper.isEqual(self.nonRecoverableError, other.nonRecoverableError) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class HFReferralModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({HFReferralAdditionalFields? additionalFields, String? id, String? tenantId, String? name, String? projectId, String? facilityId, String? symptomSurveyId, String? beneficiaryId, String? referralCode, String? nationalLevelId, String? symptom, bool? nonRecoverableError, String? clientReferenceId, int? rowVersion, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
