...
abstract class OpLogEntryCopyWith<$R, T extends EntityModel> {
  ...
  $R call({T? entity, DataOperation? operation, int? id, int? retryCount, DateTime? createdAt, String? createdBy, DataModelType? type, bool? syncedUp, bool? syncedDown, DateTime? syncedUpOn, DateTime? syncedDownOn, String? serverGeneratedId, String? clientReferenceId, List<AdditionalId>? additionalIds});
