...
class AdverseEventModelMapper extends BaseMapper<AdverseEventModel> {
  ...
  Map<String, dynamic> toMap(AdverseEventModel a) => {if (Mapper.i.$enc(a.additionalFields, 'additionalFields') != null) 'additionalFields': Mapper.i.$enc(a.additionalFields, 'additionalFields'), if (Mapper.i.$enc(a.id, 'id') != null) 'id': Mapper.i.$enc(a.id, 'id'), if (Mapper.i.$enc(a.taskClientReferenceId, 'taskClientReferenceId') != null) 'taskClientReferenceId': Mapper.i.$enc(a.taskClientReferenceId, 'taskClientReferenceId'), if (Mapper.i.$enc(a.reAttempts, 'reAttempts') != null) 'reAttempts': Mapper.i.$enc(a.reAttempts, 'reAttempts'), if (Mapper.i.$enc(a.symptoms, 'symptoms') != null) 'symptoms': Mapper.i.$enc(a.symptoms, 'symptoms'), 'clientReferenceId': Mapper.i.$enc(a.clientReferenceId, 'clientReferenceId'), if (Mapper.i.$enc(a.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(a.tenantId, 'tenantId'), if (Mapper.i.$enc(a.rowVersion, 'rowVersion') != null) 'rowVersion': Mapper.i.$enc(a.rowVersion, 'rowVersion'), if (Mapper.i.$enc(a.auditDetails, 'auditDetails') != null) 'auditDetails': Mapper.i.$enc(a.auditDetails, 'auditDetails'), if (Mapper.i.$enc(a.isDeleted, 'isDeleted') != null) 'isDeleted': Mapper.i.$enc(a.isDeleted, 'isDeleted')};
  ...
  @override int hash(AdverseEventModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.id) ^ Mapper.hash(self.taskClientReferenceId) ^ Mapper.hash(self.reAttempts) ^ Mapper.hash(self.symptoms) ^ Mapper.hash(self.clientReferenceId) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.rowVersion) ^ Mapper.hash(self.additionalFields);
  @override bool equals(AdverseEventModel self, AdverseEventModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.taskClientReferenceId, other.taskClientReferenceId) && Mapper.isEqual(self.reAttempts, other.reAttempts) && Mapper.isEqual(self.symptoms, other.symptoms) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.rowVersion, other.rowVersion) && Mapper.isEqual(self.additionalFields, other.additionalFields);
...
abstract class AdverseEventModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({AdverseEventAdditionalFields? additionalFields, String? id, String? taskClientReferenceId, int? reAttempts, List<String>? symptoms, String? clientReferenceId, String? tenantId, int? rowVersion, AuditDetails? auditDetails, bool? isDeleted});
...
abstract class FacilityModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({FacilityAdditionalFields? additionalFields, String? id, bool? isPermanent, String? usage, int? storageCapacity, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, bool? isDeleted});
...
abstract class HouseholdModelCopyWith<$R> {
  ...
  AddressModelCopyWith<$R>? get address;
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({HouseholdAdditionalFields? additionalFields, String? id, int? memberCount, double? latitude, double? longitude, double? maxRadius, String? clientReferenceId, String? tenantId, int? rowVersion, AddressModel? address, AuditDetails? auditDetails, bool? isDeleted});
...
class _HouseholdModelCopyWithImpl<$R> extends BaseCopyWith<HouseholdModel, $R> implements HouseholdModelCopyWith<$R> {
  ...
  @override AddressModelCopyWith<$R>? get address => $value.address != null ? AddressModelCopyWith($value.address!, (v) => call(address: v)) : null;
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? additionalFields = $none, Object? id = $none, Object? memberCount = $none, Object? latitude = $none, Object? longitude = $none, Object? maxRadius = $none, String? clientReferenceId, Object? tenantId = $none, Object? rowVersion = $none, Object? address = $none, Object? auditDetails = $none, Object? isDeleted = $none}) => $then(HouseholdModel(additionalFields: or(additionalFields, $value.additionalFields), id: or(id, $value.id), memberCount: or(memberCount, $value.memberCount), latitude: or(latitude, $value.latitude), longitude: or(longitude, $value.longitude), maxRadius: or(maxRadius, $value.maxRadius), clientReferenceId: clientReferenceId ?? $value.clientReferenceId, tenantId: or(tenantId, $value.tenantId), rowVersion: or(rowVersion, $value.rowVersion), address: or(address, $value.address), auditDetails: or(auditDetails, $value.auditDetails), isDeleted: or(isDeleted, $value.isDeleted)));
}
