...
class AttendancePackageRegisterModelMapper extends BaseMapper<AttendancePackageRegisterModel> {
  ...
  AttendancePackageRegisterModel fromMap(Map<String, dynamic> map) => AttendancePackageRegisterModel(additionalFields: Mapper.i.$getOpt(map, 'additionalFields'), id: Mapper.i.$get(map, 'id'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), registerNumber: Mapper.i.$getOpt(map, 'registerNumber'), name: Mapper.i.$getOpt(map, 'name'), referenceId: Mapper.i.$getOpt(map, 'referenceId'), serviceCode: Mapper.i.$getOpt(map, 'serviceCode'), status: Mapper.i.$getOpt(map, 'status'), nonRecoverableError: Mapper.i.$getOpt(map, 'nonRecoverableError') ?? false, rowVersion: Mapper.i.$getOpt(map, 'rowVersion'), staff: Mapper.i.$getOpt(map, 'staff'), attendees: Mapper.i.$getOpt(map, 'attendees'), startDate: Mapper.i.$getOpt(map, 'startDate'), endDate: Mapper.i.$getOpt(map, 'endDate'));
...
abstract class AttendancePackageRegisterModelCopyWith<$R> {
  ...
  $R call({AttendanceRegisterAdditionalFields? additionalFields, String? id, String? tenantId, String? registerNumber, String? name, String? referenceId, String? serviceCode, String? status, bool? nonRecoverableError, int? rowVersion, List<StaffModel>? staff, List<AttendeeModel>? attendees, int? startDate, int? endDate});
