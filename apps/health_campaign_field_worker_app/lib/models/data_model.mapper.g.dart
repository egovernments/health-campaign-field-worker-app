...
class HCMAttendanceLogSearchModelMapper extends BaseMapper<HCMAttendanceLogSearchModel> {
  ...
  HCMAttendanceLogSearchModel fromMap(Map<String, dynamic> map) => HCMAttendanceLogSearchModel.ignoreDeleted(id: Mapper.i.$getOpt(map, 'id'), registerId: Mapper.i.$getOpt(map, 'registerId'), individualId: Mapper.i.$getOpt(map, 'individualId'), status: Mapper.i.$getOpt(map, 'status'), type: Mapper.i.$getOpt(map, 'type'), tenantId: Mapper.i.$getOpt(map, 'tenantId'), time: Mapper.i.$getOpt(map, 'time'), clientReferenceId: Mapper.i.$getOpt(map, 'clientReferenceId'));

  @override Function get encoder => (HCMAttendanceLogSearchModel v) => encode(v);
  dynamic encode(HCMAttendanceLogSearchModel v) => toMap(v);
  Map<String, dynamic> toMap(HCMAttendanceLogSearchModel h) => {if (Mapper.i.$enc(h.id, 'id') != null) 'id': Mapper.i.$enc(h.id, 'id'), if (Mapper.i.$enc(h.registerId, 'registerId') != null) 'registerId': Mapper.i.$enc(h.registerId, 'registerId'), if (Mapper.i.$enc(h.individualId, 'individualId') != null) 'individualId': Mapper.i.$enc(h.individualId, 'individualId'), if (Mapper.i.$enc(h.status, 'status') != null) 'status': Mapper.i.$enc(h.status, 'status'), if (Mapper.i.$enc(h.type, 'type') != null) 'type': Mapper.i.$enc(h.type, 'type'), if (Mapper.i.$enc(h.tenantId, 'tenantId') != null) 'tenantId': Mapper.i.$enc(h.tenantId, 'tenantId'), if (Mapper.i.$enc(h.time, 'time') != null) 'time': Mapper.i.$enc(h.time, 'time'), if (Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId') != null) 'clientReferenceId': Mapper.i.$enc(h.clientReferenceId, 'clientReferenceId')};

  @override String stringify(HCMAttendanceLogSearchModel self) => 'HCMAttendanceLogSearchModel(boundaryCode: ${Mapper.asString(self.boundaryCode)}, isDeleted: ${Mapper.asString(self.isDeleted)}, auditDetails: ${Mapper.asString(self.auditDetails)}, additionalFields: ${Mapper.asString(self.additionalFields)}, id: ${Mapper.asString(self.id)}, tenantId: ${Mapper.asString(self.tenantId)}, registerId: ${Mapper.asString(self.registerId)}, individualId: ${Mapper.asString(self.individualId)}, time: ${Mapper.asString(self.time)}, type: ${Mapper.asString(self.type)}, status: ${Mapper.asString(self.status)}, clientReferenceId: ${Mapper.asString(self.clientReferenceId)})';
  @override int hash(HCMAttendanceLogSearchModel self) => Mapper.hash(self.boundaryCode) ^ Mapper.hash(self.isDeleted) ^ Mapper.hash(self.auditDetails) ^ Mapper.hash(self.additionalFields) ^ Mapper.hash(self.id) ^ Mapper.hash(self.tenantId) ^ Mapper.hash(self.registerId) ^ Mapper.hash(self.individualId) ^ Mapper.hash(self.time) ^ Mapper.hash(self.type) ^ Mapper.hash(self.status) ^ Mapper.hash(self.clientReferenceId);
  @override bool equals(HCMAttendanceLogSearchModel self, HCMAttendanceLogSearchModel other) => Mapper.isEqual(self.boundaryCode, other.boundaryCode) && Mapper.isEqual(self.isDeleted, other.isDeleted) && Mapper.isEqual(self.auditDetails, other.auditDetails) && Mapper.isEqual(self.additionalFields, other.additionalFields) && Mapper.isEqual(self.id, other.id) && Mapper.isEqual(self.tenantId, other.tenantId) && Mapper.isEqual(self.registerId, other.registerId) && Mapper.isEqual(self.individualId, other.individualId) && Mapper.isEqual(self.time, other.time) && Mapper.isEqual(self.type, other.type) && Mapper.isEqual(self.status, other.status) && Mapper.isEqual(self.clientReferenceId, other.clientReferenceId);
...
abstract class HCMAttendanceLogSearchModelCopyWith<$R> {
  ...
  $R call({String? id, String? registerId, String? individualId, String? status, String? type, String? tenantId, int? time, List<String>? clientReferenceId});
...
abstract class HCMAttendanceLogModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  ClientAuditDetailsCopyWith<$R>? get clientAuditDetails;
  $R call({String? id, String? registerId, String? individualId, int? status, String? type, String? tenantId, int? time, String? clientReferenceId, String? name, int? rowVersion, bool? nonRecoverableError, AuditDetails? auditDetails, ClientAuditDetails? clientAuditDetails, bool? isDeleted});
