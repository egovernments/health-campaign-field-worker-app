...
_MdmsModuleDetailModel _$MdmsModuleDetailModelFromJson(
...
Map<String, dynamic> _$MdmsModuleDetailModelToJson(
  _MdmsModuleDetailModel instance,
) => <String, dynamic>{
  'moduleName': instance.moduleName,
  'masterDetails': instance.masterDetails,
};

_MdmsMasterDetailModel _$MdmsMasterDetailModelFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$MdmsMasterDetailModelToJson(
  _MdmsMasterDetailModel instance,
) => <String, dynamic>{'name': instance.name, 'filter': instance.filter};
...
_BoundaryRelationship _$BoundaryRelationshipFromJson(
  Map<String, dynamic> json,
  ...
  children: (json['children'] as List<dynamic>?)
      ?.map((e) => BoundaryRelationshipRef.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$BoundaryRelationshipToJson(
  _BoundaryRelationship instance,
) => <String, dynamic>{
...
_BoundaryRelationshipRef _$BoundaryRelationshipRefFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$BoundaryRelationshipRefToJson(
  _BoundaryRelationshipRef instance,
) => <String, dynamic>{
  'boundaryType': instance.boundaryType,
  'order': instance.order,
};
