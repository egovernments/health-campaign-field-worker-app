...
void _appConfigurationSerialize(
  ...
  writer.writeString(offsets[12], object.networkDetection);
  writer.writeString(offsets[13], object.persistenceMode);
  writer.writeString(offsets[14], object.syncMethod);
  writer.writeString(offsets[15], object.syncTrigger);
...
AppConfiguration _appConfigurationDeserialize(
  ...
  object.networkDetection = reader.readStringOrNull(offsets[12]);
  object.persistenceMode = reader.readStringOrNull(offsets[13]);
  object.syncMethod = reader.readStringOrNull(offsets[14]);
  object.syncTrigger = reader.readStringOrNull(offsets[15]);
