                        ...
                        builder: (context, form, child) => Column(
                          children: [
                                        ...
                                        builder: (field) {
                                          return LabeledField(
                                            ...
                                            child: DigitDropdown<int>(
                                              isDisabled:
                                                  false, // Adjust this based on your requirements
                                              onSelect: (item) {
                                                print(
                                                    '${item} iiiiiiiiiiiiiiiiiiiiiiii');
                                                // Print all filtered items
                                                print("Filtered Items:");
                                                for (var item
                                                    in filteredItems) {
                                                  print(
                                                      "Code: ${item.code}, Name: ${item.name}, Label: ${item.label}");
                                                }
                                                // Find the matching BoundaryModel from the list using the selected code
                                                final selectedBoundary =
                                                    filteredItems.firstWhere(
                                                  (item) =>
                                                      item.code == item.code,
                                                  orElse: () => throw Exception(
                                                      'Boundary not found for code: ${item.code}'),
                                                );
                                                // Update the form control with the selected value
                                                formControls[label]
                                                    ?.updateValue(
                                                        selectedBoundary);
                                                // Dispatch the necessary events with the matched BoundaryModel
                                                context
                                                    .read<BoundaryBloc>()
                                                    .add(
                                                      BoundarySearchEvent(
                                                ...
                                                // Reset child dropdowns if needed
                                                resetChildDropdowns(
                                                    label, state);
                                              },
                                              ...
                                              isSearchable:
                                                  true, // Adjust this based on your requirements
                                              items: filteredItems
                                                  .map(
                                                    (item) => DropdownItem(
                                                      name: localizations
                            ...
                            BlocListener<BeneficiaryDownSyncBloc,
                              ...
                              child: DigitCard(
                                margin:
                                    const EdgeInsets.fromLTRB(0, spacer2, 0, 0),
                                children: [
                                  SafeArea(
