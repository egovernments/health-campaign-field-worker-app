...
//                     "format": "tag",
//                     "visible":
//                         "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, referral, task)}}==false",
...
//                     "format": "tag",
//                     "visible":
//                         "{{fn:isDelivered(task.0.status)}}==true && {{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, referral, task)}}==true",
...
//                     "format": "tag",
//                     "visible":
//                         "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, referral, task)}}==true && {{fn:isDelivered(task.0.status)}}==false",
...
//                     "format": "button",
//                     "visible":
//                         "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, referral, task)}} == true  && {{fn:checkAllDoseDelivered(task)}} == false",
//                     "onAction": [
//                       {
//                         "actionType": "NAVIGATION",
//                         "properties": {
...
//                     "format": "button",
//                     "visible":
//                         "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, referral, task)}} == true &&  {{fn:checkAllDoseDelivered(task)}} == true",
//                     "onAction": [
//                       {
//                         "actionType": "NAVIGATION",
//                         "properties": {
...
final dynamic sampleFlows = {
  ...
  "auditDetails": {
    ...
    "lastModifiedTime": 1769595811792
  }
};
...
//                                                     "label": "NOT_ELIGIBLE",
//                                                     "format": "tag",
//                                                     "visible": "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, task)}}==false",
//                                                     "fieldName": "notEligible",
//                                                     "properties": {
//                                                         "tagType": "error"
//                                                     }
...
//                                                     "label": "ADMINISTERED_SUCCESS",
//                                                     "format": "tag",
//                                                     "visible": "{{fn:isDelivered(task.0.status)}}==true && {{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, task)}}==true && {{fn:length(referral)}} <= 0",
//                                                     "fieldName": "administrationSuccess",
//                                                     "properties": {
//                                                         "tagType": "success",
//                                                         "bottomGap": 16
...
//                                                     "label": "NOT_VISITED",
//                                                     "format": "tag",
//                                                     "visible": "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, task)}}==true && {{fn:isDelivered(task.0.status)}}==false && {{fn:length(referral)}} <= 0",
//                                                     "fieldName": "notVisited",
//                                                     "properties": {
//                                                         "tagType": "info",
//                                                         "bottomGap": 16
...
//                                                     "label": "DELIVERY",
//                                                     "format": "button",
//                                                     "visible": "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, task)}} == true  && {{fn:checkAllDoseDelivered(task)}} == false && {{fn:length(referral)}} <= 0",
//                                                     "onAction": [
//                                                         {
//                                                             "actionType": "NAVIGATION",
//                                                             "properties": {
...
//                                                                     {
//                                                                         "key": "ProjectBeneficiaryClientReferenceId",
//                                                                         "value": "{{projectBeneficiary.0.clientReferenceId}}"
//                                                                     }
//                                                                 ],
//                                                                 "name": "CHECKLIST",
//                                                                 "type": "FORM"
...
//                                                     "label": "REGISTRATION_VIEW_DETAILS",
//                                                     "format": "button",
//                                                     "visible": "{{fn:checkEligibilityForAgeAndSideEffect(individual.0.dateOfBirth, task)}} == true &&  {{fn:checkAllDoseDelivered(task)}} == true && {{fn:length(referral)}} <= 0",
//                                                     "onAction": [
//                                                         {
//                                                             "actionType": "NAVIGATION",
//                                                             "properties": {
