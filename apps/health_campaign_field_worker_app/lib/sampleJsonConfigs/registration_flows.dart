final dynamic sampleFlows = {
  "id": "9ad2c09d-a027-4e45-99a2-9cd7fe45bf40",
  "tenantId": "mz",
  "schemaCode": "HCM-ADMIN-CONSOLE.FormConfig",
  "uniqueIdentifier": "REGISTRATION.CMP-2026-06-16-006203",
  "data": {
    "name": "REGISTRATION",
    "flows": [
      {
          ...
          },
          {
            ...
            "children": [
              ...
              },
              {
                "type": "template",
                "format": "expandable",
                "fieldName": "pastCyclesExpandable",
        ...
        "body": [
          {
            "type": "template",
            "format": "card",
            "fieldName": "householdOverviewCard",
            "children": [
              {
                "type": "template",
                "format": "row",
              ...
              },
              {
                ...
                "child": {
                  ...
                  "children": [
                    ...
                    {
                      "type": "template",
                      "label": "ADMINISTRATION_SUCCESS_TAG",
                      "format": "tag",
                      "visible":
                  ...
                  "popupConfig": {
                    ...
                    "footerActions": [
                      ...
                      },
                      {
                        "type": "template",
                        "label":
                            "REGISTRATION_SEARCH_BENEFICIARY_DOWNLOAD_IDS_LABEL",
                        "format": "button",
                        "onAction": [
                          {
                            "actionType": "CLOSE_POPUP",
            ...
            "footer": [
              {
                ...
                "format": "button",
                "fieldName": "unableToDeliverSubmit",
                "onAction": [
                  {
                    "actionType": "NAVIGATION",
                    "properties": {
                    ...
                    "enums": [
                      {
                        ...
                        "name": "REGISTRATION_FILTER_VACCINATED"
                      },
                      {
                        "code": "NOT_ADMINISTERED",
                        "name": "REGISTRATION_FILTER_NOT_VACCINATED"
                      },
            ...
            "footer": [
              {
                ...
                "format": "button",
                "fieldName": "deliveryChecklistSubmit",
                "onAction": [
                  {
                    "actionType": "NAVIGATION",
                    "properties": {
            ...
            "footer": [
              {
                ...
                "format": "button",
                "fieldName": "deliveryDetailsSubmit",
                "onAction": [
                  {
                    "actionType": "NAVIGATION",
                    "properties": {
            ...
            "footer": [
              {
                ...
                "format": "button",
                "fieldName": "referBeneficiarySubmit",
                "onAction": [
                  {
                    "actionType": "NAVIGATION",
            ...
            "footer": [
              {
                ...
                "format": "button",
                "fieldName": "beneficiaryDetailsSubmit",
                "onAction": [
                  {
                    "actionType": "NAVIGATION",
                    "properties": {
            ...
            "footer": [
              {
                ...
                "format": "button",
                "fieldName": "householdDetailsSubmit",
                "onAction": [
                  {
                    "actionType": "NAVIGATION",
            ...
            "footer": [
              {
                ...
                "format": "button",
                "fieldName": "beneficiaryLocationSubmit",
                "onAction": [
                  {
                    "actionType": "NAVIGATION",
  ...
  "isActive": true,
  "auditDetails": {
    "createdBy": "d2314122-e795-462a-bef3-eea940559369",
    "lastModifiedBy": "8b110055-330f-4e7b-b4c0-f618f29b9d47",
    "createdTime": 1781592295841,
    "lastModifiedTime": 1781615114724
  }
};
