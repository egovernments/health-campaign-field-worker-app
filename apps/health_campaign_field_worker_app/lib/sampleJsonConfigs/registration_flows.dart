              ...
              "properties": {
                "data": [
                  ...
                  {"key": "doseIndex", "value": "{{contextData.nextDoseId}}"},
                  {
                    ...
                    "value":
                        "{{contextData.currentDelivery.0.deliveryStrategy}}"
                  },
                  {
                    "key": "totalDosesInCycle",
                    "value": "{{contextData.deliveryLength}}"
                  },
                  {
                    "key": "futureDoses",
                    "value": "{{contextData.targetCycle.0.deliveries}}"
                  }
                ],
                "name": "DELIVERY",
                "type": "FORM"
      ...
      "onAction": [
        {
          ...
          "properties": {
            "data": [
              ...
              {
                "key": "deliveryStrategy",
                "value": "{{contextData.navigation.deliveryStrategy}}"
              }
            ],
            "onError": [
              {
          ...
          "actions": [
            {
              ...
              "properties": {
                "data": [
                  ...
                  {
                    "key": "futureDoses",
                    "value": "{{contextData.navigation.futureDoses}}"
                  }
                ],
                "onError": [
                  {
