      ...
      "pages": [
        {
          ...
          "footer": [
            {
              ...
              "onAction": [
                {
                  "actionType": "NAVIGATION",
                  "properties": {"name": "caregiverConsent", "type": "form"}
                }
              ],
              "properties": {
                "size": "large",
          ...
          "navigateTo": {"name": "caregiverConsent", "type": "form"},
          "properties": [
            {
              "type": "string",
              "label":
          ...
          "actionLabel":
              "APPONE_REGISTRATION_BENEFICIARY_LOCATION_ACTION_BUTTON_LABEL_1_1",
          "description":
          ...
          "onAction": [
            {
              ...
              "condition": {"expression": "consentToParticipate==YES"}
            },
            {
              "actions": [
                {
      ...
      "body": [
        {
          ...
          "primaryAction": {
            "type": "template",
            "label":
                "CAREGIVER_ACKNOWLEDGEMENT_SUCCESS_PANEL_CARD_ACTION_LABEL",
            "format": "button",
            "hidden": false,
            "onAction": [
              {
            ...
            "fieldName": "backToHouseholdDetails",
            "mandatory": true,
            "properties": {"type": "primary"}
          }
        }
