...
class UniqueIdBloc extends Bloc<UniqueIdEvent, UniqueIdState> {
  ...
  final int beneficiaryIdMinCount;
  final int beneficiaryIdBatchSize;
  ...
  UniqueIdBloc({
    ...
    required this.beneficiaryIdMinCount,
    required this.beneficiaryIdBatchSize,
  ...
  FutureOr<void> _fetchUniqueIdsFromServer(
    ...
    try {
      ...
      int batchSize = beneficiaryIdBatchSize;
      int totalLimit = 0;
