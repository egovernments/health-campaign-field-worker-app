...
class __$$DownSyncBeneficiaryEventImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? clfServerCount = null,
    Object? clfMemberServerCount = null,
    Object? boundaryName = null,
    Object? isCommunityCreator = null,
    ...
    return _then(_$DownSyncBeneficiaryEventImpl(
      ...
      initialServerCount: null == initialServerCount
          ...
          : initialServerCount // ignore: cast_nullable_to_non_nullable
              as int,
      clfServerCount: null == clfServerCount
          ? _value.clfServerCount
          : clfServerCount // ignore: cast_nullable_to_non_nullable
              as int,
      clfMemberServerCount: null == clfMemberServerCount
          ? _value.clfMemberServerCount
          : clfMemberServerCount // ignore: cast_nullable_to_non_nullable
              as int,
      boundaryName: null == boundaryName
          ? _value.boundaryName
          : boundaryName // ignore: cast_nullable_to_non_nullable
              as String,
      isCommunityCreator: null == isCommunityCreator
          ? _value.isCommunityCreator
          : isCommunityCreator // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$DownSyncBeneficiaryEventImpl implements DownSyncBeneficiaryEvent {
  const _$DownSyncBeneficiaryEventImpl(
      ...
      required this.clfServerCount,
      required this.clfMemberServerCount,
      required this.boundaryName,
      required this.isCommunityCreator,
  ...
  @override
  final int clfServerCount;
  @override
  final int clfMemberServerCount;
  @override
  final String boundaryName;
  @override
  final bool isCommunityCreator;
  @override
  final bool isDistributor;

  @override
  String toString() {
    return 'BeneficiaryDownSyncEvent.downSync(projectId: $projectId, boundaryCode: $boundaryCode, batchSize: $batchSize, initialServerCount: $initialServerCount, clfServerCount: $clfServerCount, clfMemberServerCount: $clfMemberServerCount, boundaryName: $boundaryName, isCommunityCreator: $isCommunityCreator, isDistributor: $isDistributor)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.clfServerCount, clfServerCount) ||
                other.clfServerCount == clfServerCount) &&
            (identical(other.clfMemberServerCount, clfMemberServerCount) ||
                other.clfMemberServerCount == clfMemberServerCount) &&
            (identical(other.boundaryName, boundaryName) ||
                other.boundaryName == boundaryName) &&
            (identical(other.isCommunityCreator, isCommunityCreator) ||
                other.isCommunityCreator == isCommunityCreator) &&
...
abstract class DownSyncBeneficiaryEvent implements BeneficiaryDownSyncEvent {
  const factory DownSyncBeneficiaryEvent(
      ...
      required final int clfServerCount,
      required final int clfMemberServerCount,
      required final String boundaryName,
      required final bool isCommunityCreator,
      required final bool isDistributor}) = _$DownSyncBeneficiaryEventImpl;

  String get projectId;
  String get boundaryCode;
  int get batchSize;
  int get initialServerCount;
  int get clfServerCount;
  int get clfMemberServerCount;
...
class _$DownSyncCheckTotalCountEventImpl
  ...
  @override
  String toString() {
    return 'BeneficiaryDownSyncEvent.checkForData(projectId: $projectId, boundaryCode: $boundaryCode, pendingSyncCount: $pendingSyncCount, batchSize: $batchSize, boundaryName: $boundaryName, isCommunityCreator: $isCommunityCreator, isDistributor: $isDistributor)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return checkForData(projectId, boundaryCode, pendingSyncCount, batchSize,
        boundaryName, isCommunityCreator, isDistributor);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return checkForData?.call(projectId, boundaryCode, pendingSyncCount,
        batchSize, boundaryName, isCommunityCreator, isDistributor);
  }
...
abstract class DownSyncCheckTotalCountEvent
  ...
  const factory DownSyncCheckTotalCountEvent(
      ...
      required final String boundaryName,
      required final bool isCommunityCreator,
      required final bool isDistributor}) = _$DownSyncCheckTotalCountEventImpl;
...
mixin _$BeneficiaryDownSyncState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int initialServerCount, int initialCLFCount,
            int initialCLFMemberCount, int batchSize)
        dataFound,
    required TResult Function() resetState,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int initialServerCount, int initialCLFCount,
            int initialCLFMemberCount, int batchSize)?
        dataFound,
    TResult? Function()? resetState,
...
class __$$DownSyncDataFoundStateImplCopyWithImpl<$Res>
  ...
  $Res call({
    Object? initialServerCount = null,
    Object? initialCLFCount = null,
    Object? initialCLFMemberCount = null,
    Object? batchSize = null,
  }) {
    return _then(_$DownSyncDataFoundStateImpl(
      null == initialServerCount
          ...
          : initialServerCount // ignore: cast_nullable_to_non_nullable
              as int,
      null == initialCLFCount
          ? _value.initialCLFCount
          : initialCLFCount // ignore: cast_nullable_to_non_nullable
              as int,
      null == initialCLFMemberCount
          ? _value.initialCLFMemberCount
          : initialCLFMemberCount // ignore: cast_nullable_to_non_nullable
              as int,
      null == batchSize
          ? _value.batchSize
          : batchSize // ignore: cast_nullable_to_non_nullable
...
class _$DownSyncDataFoundStateImpl extends _DownSyncDataFoundState {
  const _$DownSyncDataFoundStateImpl(this.initialServerCount,
      this.initialCLFCount, this.initialCLFMemberCount, this.batchSize)
      : super._();

  @override
  final int initialServerCount;
  @override
  final int initialCLFCount;
  @override
  final int initialCLFMemberCount;
  @override
  final int batchSize;

  @override
  String toString() {
    return 'BeneficiaryDownSyncState.dataFound(initialServerCount: $initialServerCount, initialCLFCount: $initialCLFCount, initialCLFMemberCount: $initialCLFMemberCount, batchSize: $batchSize)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.initialServerCount, initialServerCount) ||
                other.initialServerCount == initialServerCount) &&
            (identical(other.initialCLFCount, initialCLFCount) ||
                other.initialCLFCount == initialCLFCount) &&
            (identical(other.initialCLFMemberCount, initialCLFMemberCount) ||
                other.initialCLFMemberCount == initialCLFMemberCount) &&
            (identical(other.batchSize, batchSize) ||
                other.batchSize == batchSize));
  }
  ...
  int get hashCode => Object.hash(runtimeType, initialServerCount,
      initialCLFCount, initialCLFMemberCount, batchSize);
  ...
  TResult when<TResult extends Object?>({
    ...
    return dataFound(
        initialServerCount, initialCLFCount, initialCLFMemberCount, batchSize);
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    if (dataFound != null) {
      return dataFound(initialServerCount, initialCLFCount,
          initialCLFMemberCount, batchSize);
    }
    return orElse();
  }
...
abstract class _DownSyncDataFoundState extends BeneficiaryDownSyncState {
  const factory _DownSyncDataFoundState(
      ...
      final int initialCLFCount,
      final int initialCLFMemberCount,
      final int batchSize) = _$DownSyncDataFoundStateImpl;
  const _DownSyncDataFoundState._() : super._();

  int get initialServerCount;
  int get initialCLFCount;
  int get initialCLFMemberCount;
  int get batchSize;
  @JsonKey(ignore: true)
  _$$DownSyncDataFoundStateImplCopyWith<_$DownSyncDataFoundStateImpl>
      get copyWith => throw _privateConstructorUsedError;
