...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthUnauthenticatedState value)?  unauthenticated,TResult Function( AuthLoadingState value)?  loading,TResult Function( AuthAuthenticatedState value)?  authenticated,TResult Function( AuthErrorState value)?  error,TResult Function( AuthOtherDeviceState value)?  otherDevice,TResult Function( AuthAllowState value)?  allow,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return loading(_that);case AuthAuthenticatedState() when authenticated != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthUnauthenticatedState value)  unauthenticated,required TResult Function( AuthLoadingState value)  loading,required TResult Function( AuthAuthenticatedState value)  authenticated,required TResult Function( AuthErrorState value)  error,required TResult Function( AuthOtherDeviceState value)  otherDevice,required TResult Function( AuthAllowState value)  allow,}){
final _that = this;
switch (_that) {
case AuthUnauthenticatedState():
return unauthenticated(_that);case AuthLoadingState():
return loading(_that);case AuthAuthenticatedState():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthUnauthenticatedState value)?  unauthenticated,TResult? Function( AuthLoadingState value)?  loading,TResult? Function( AuthAuthenticatedState value)?  authenticated,TResult? Function( AuthErrorState value)?  error,TResult? Function( AuthOtherDeviceState value)?  otherDevice,TResult? Function( AuthAllowState value)?  allow,}){
final _that = this;
switch (_that) {
case AuthUnauthenticatedState() when unauthenticated != null:
return unauthenticated(_that);case AuthLoadingState() when loading != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  unauthenticated,TResult? Function()?  loading,TResult? Function( String accessToken,  String refreshToken,  UserRequestModel userModel,  RoleActionsWrapperModel actionsWrapper,  String? individualId)?  authenticated,TResult? Function( String? error)?  error,TResult? Function()?  otherDevice,TResult? Function()?  allow,}) {final _that = this;
switch (_that) {
case AuthUnauthenticatedState() when unauthenticated != null:
return unauthenticated();case AuthLoadingState() when loading != null:
return loading();case AuthAuthenticatedState() when authenticated != null:
