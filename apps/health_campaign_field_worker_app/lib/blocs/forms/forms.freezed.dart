...
class _$FormsStateImpl implements _FormsState {
  const _$FormsStateImpl({this.schema});
  ...
  @override
  String toString() {
    return 'FormsState(schema: $schema)';
  }
...
abstract class _FormsState implements FormsState {
  const factory _FormsState({final SchemaObject? schema}) = _$FormsStateImpl;
